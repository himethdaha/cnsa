...
@section ('body')
@include ('errors')
<form method="post" action="{{action('PlayersHistoryController@update', $playerhistoryid)}}" style="padding-top:0px; text-align: center;">
  {{csrf_field()}}
  ...
  <div class="form-group row">
    ...
    <input type="text" class="form-control" value="{{$playerhistory-> team_id}}" name="team_id" placeholder="Enter Team ID">
  </div>
  <div class="form-group row">
